...
<div class="container-fluid">
	<form action="" id="type-form">
		...
		<div class="form-group">
			<label for="city_price" class="control-label">Air Frieght Price per kg.</label>
		...
		<div class="form-group">
			<label for="state_price" class="control-label">Land Shipping Price per kg.</label>
		...
		<div class="form-group">
			<label for="country_price" class="control-label">Sea Transport Price per kg.</label>
