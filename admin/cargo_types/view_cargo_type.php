...
<div class="container-fluid">
	<dl>
        <dt class="text-muted">Product Categories</dt>
        <dd class="pl-4"><?= isset($name) ? $name : "" ?></dd>
        <dt class="text-muted">Description</dt>
        <dd class="pl-4"><?= isset($description) ? $description : '' ?></dd>
        <dt class="text-muted">Air Frieght Price per kg.</dt>
        <dd class="pl-4"><?= isset($city_price) ? format_num($city_price) : '' ?></dd>
        <dt class="text-muted">Land Shipping Price per kg.</dt>
        <dd class="pl-4"><?= isset($state_price) ? format_num($state_price) : '' ?></dd>
        <dt class="text-muted">Sea Transport Price per kg.</dt>
