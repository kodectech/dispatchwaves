...
<style>
  ...
  <body class="sidebar-mini layout-fixed  layout-navbar-fixed sidebar-mini-md sidebar-mini-xs text-sm custom-index" data-new-gr-c-s-check-loaded="14.991.0" data-gr-ext-installed="" style="height: auto;">
    <div class="wrapper">
