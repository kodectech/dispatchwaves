    ...
    <div class="card card-outline card-primary rounded-0 shadow">
        ...
        <div class="card-body">
            ...
            <div id="outprint">
                        ...
                        <fieldset>
                            ...
                            <div class="pl-3">
                                <span>
                                    ...
                                    <?php
									$status = isset($status) ? $status : '';
									if (isset($shipping_type) && $shipping_type == 1 ) {
										echo 'Air frieght';
									}
									elseif (isset ($shipping_type) && $shipping_type == 2){
									    echo 'Land Transport';
									}
									else {
									    echo 'Sea Shipping';
                ...
                <div class="clear-fix my-3"></div>
                <div class="row">
                <table style="border: 1px solid black; width: 90%; overflow:hidden;">
                <div class="col-lg-4 col-md-4 col-sm-4">
                       
                            <tr>
                                <th style="border: 1px solid black; "><large class="font-weight-bolder">Product Category</large></th>
                                <th style="border: 1px solid black; "><large class="font-weight-bolder">Total Freight</large></th>
                                <th style="border: 1px solid black;"><large class="font-weight-bolder">Weight(kg)</large></th>


                            </tr>

                            <tr>
                                <td style="border: 1px solid black;"><span><?= isset($product_category) ? $product_category : "" ?></span></td>
                                <td style="border: 1px solid black;"><span><?= isset($total_freight) ? $total_freight : "" ?></span></td>
                                <td style="border: 1px solid black;"><span><?= isset($weight_kg) ? $weight_kg : "" ?></span></td>
                            </tr>
