...
(1, 'sender_name', 'Jack Obi'),
(1, 'sender_contact', '095523456789'),
(1, 'sender_address', 'Testing address'),
(1, 'sender_provided_id_type', 'TIN121'),
(1, 'sender_provided_id', '45246546689954'),
(1, 'receiver_name', 'SJJJ Taboo'),
(1, 'receiver_contact', '054542213'),
(1, 'receiver_address', 'This a sample address only2'),
(1, 'from_location', 'This is a sample From Location2'),
(1, 'product_category', 'SJJJ Taboo'),
(1, 'total_freight', 'first detail'),
(1, 'weight_kg', 'first detail'),
(1, 'Carrier', 'first Carrier'),
(1, 'detail1', 'first detail'),
(1, 'currrent_location1', 'first detail'),
(1, 'arrival_day1', 'first detail'),
(1, 'arrival_date1', 'first detail'),
(1, 'arrival_country1', 'first detail'),
(1, 'comment1', 'first detail'),
(1, 'detail2', 'first detail'),
(1, 'currrent_location2', 'first detail'),
(1, 'arrival_day2', 'first detail'),
(1, 'arrival_date2', 'first detail'),
(1, 'arrival_country2', 'first detail'),
(1, 'comment2', 'first detail'),
(1, 'detail3', 'first detail'),
(1, 'currrent_location3', 'first detail'),
(1, 'arrival_day3', 'first detail'),
(1, 'arrival_date3', 'first detail'),
(1, 'arrival_country3', 'first detail'),
(1, 'comment3', 'first detail'),
(1, 'detail4', 'first detail'),
(1, 'currrent_location1', 'first detail'),
(1, 'arrival_day4', 'first detail'),
(1, 'arrival_date4', 'first detail'),
(1, 'arrival_country4', 'first detail'),
(1, 'comment4', 'first detail'),
